    ...
    // y = tail coordinates time = time tail = snake length - 1
...
public:
    Snake()
    {
        ...
        x = 1000; //Position of snake at the beginning
        Dollars = 0; //Money
        Bonus = 0;
    ...
    friend void sp();//Choose colour function
    friend void s(); //Forget choose colour choice
};
////////////////////////////////////////////////////////////////////////////////// Windows
void clearscreen()
{
...
void s()
{
    ...
    //FUNCTION TO ..EHM FORGET COLOR,not sure how to say I know: Stop using colour
}
////////////////////////////////////////////////////////////////////////////////// ^ Windows
void Snake::Start()
{
...

{
    ...
    switch( key )
    {
            ...
            //,but let me give a simple explanation of first case:
        {
            ...
            break; //We break it,end of the case.Identical with other cases..
        }
...
void Snake::GameLogic()
{
    ...
    //very end of the snake(tail) will not be deleted ( line 276 ) for 1 frame
    {
        ...
        Dollars++; //Apple had some dollars in it, congratulations!
    }
